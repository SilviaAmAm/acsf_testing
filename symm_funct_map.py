...
def acsf_rad_1(xyzs, Zs, radial_cutoff, radial_rs, eta):
    ...
    with tf.name_scope("Distances"):
        ...
        dist_tensor = tf.cast(tf.norm(dxyzs, axis=2), dtype=tf.float32)  # (n_atoms, n_atoms)
...
def generate_parkhill_acsf_1(xyzs, Zs, elements, element_pairs, radial_cutoff, angular_cutoff, radial_rs, angular_rs, theta_s, zeta, eta):
